 ...
 * clevo-xsm-wmi.c
 *
 * Copyright (C) 2019-2020 Comexr B.V. The Netherlands <info@laptopmetlinux.nl>
 * Custom build Linux laptops and Mini computers: https://laptopmetlinux.nl/
 * Customized for COMEXR Clevo laptops
 *
...
static struct dmi_system_id clevo_xsm_dmi_table[] __initdata = {
	...
	},
	{
        .ident = "Clevo NHxxRZQ",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "NHxxRZQ"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
	{
        .ident = "Clevo NJ50_70CU",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "NJ50_70CU"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
    {
        .ident = "Clevo NJ5x_NJ7xLU",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "NJ5x_NJ7xLU"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
	...
	{
        .ident = "Clevo NL40_50CU",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "NL40_50CU"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
    {
        .ident = "Clevo NH5x_7xDCx_DDx",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "NH5x_7xDCx_DDx"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
	{
        .ident = "Clevo NH50_70RH",
        .matches = {
    ...
    },
	{
        .ident = "Clevo NHxxRHQ",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "NHxxRHQ"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
	{
        .ident = "Clevo NHx0DB,DE",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "NHx0DB,DE"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
	{
        .ident = "Clevo N150CU",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "N150CU"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
    {
        .ident = "Clevo NL4x_NL5xLU",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "NL4x_NL5xLU"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
    ...
    },
	{
        .ident = "Clevo X170SM",
        .matches = {
            DMI_MATCH(DMI_PRODUCT_NAME, "X170SM"),
        },
        .callback = clevo_xsm_dmi_matched,
        .driver_data = &kb_full_color_ops,
    },
